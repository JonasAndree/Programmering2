...
public class MazePanel extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		img = LoadImageApp("src/lesson/maze/painting/images2/images/TilesforJonas-1.1.png");
		img2 = LoadImageApp("src/lesson/maze/painting/images2/images/PlayerforJonas-1.0.png");
	...
	private void drawMaze(Graphics g, ArrayList<ArrayList<Character>> maze) {
		...
		for (ArrayList<Character> row : maze) {
			for (char cell : row) {
				 ...
				 * img2.getWidth() / 2, img2.getHeight() / 2);
				 * 
				 * AffineTransformOp op = new AffineTransformOp(tx,
				 * AffineTransformOp.TYPE_BILINEAR); img2 = op.filter(img2, null);
				 */
		 ...
		 * /*g2.drawImage(loadImage("TilesforJonas-1.1.png"), 0, 0, 200, 200, 0, 0, 200,
		 * 200, null);
		 */
		/* END OF NEW CODE! */
	}
